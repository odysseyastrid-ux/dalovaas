...
(function () {
  const STRINGS = {
    ...
    'terms.hero.title': { en: 'Terms of Service', fr: 'Conditions d’utilisation' },
    'terms.hero.lede': { en: 'Last updated 2026. These terms apply when you request a quote, book a cleaning, or use this website.', fr: 'Dernière mise à jour en 2026. Ces conditions s’appliquent lorsque vous demandez un devis, réservez un ménage, ou utilisez ce site.' },
    'terms.quotes.title': { en: 'Quotes & pricing', fr: 'Devis et tarification' },
    'terms.quotes.p1': { en: 'Quotes are estimates based on the information you provide (home size, type, and any notes or photos). If your home\'s actual condition differs materially, the final price may be adjusted and confirmed with you before or at the time of service.', fr: 'Les devis sont des estimations basées sur les renseignements que vous fournissez (taille du logement, type, et toute note ou photo). Si l’état réel du logement diffère de façon importante, le prix final pourrait être ajusté et confirmé avec vous avant ou pendant le service.' },
    'terms.deposits.title': { en: 'Deposits', fr: 'Dépôts' },
    'terms.deposits.p1': { en: 'Online bookings may require a deposit, paid securely through Stripe, to confirm your appointment. Deposit terms are shown at checkout before you pay.', fr: 'Les réservations en ligne peuvent exiger un dépôt, payé de façon sécurisée via Stripe, afin de confirmer votre rendez-vous. Les conditions du dépôt sont indiquées avant le paiement.' },
    'terms.cancel.title': { en: 'Cancellations & rescheduling', fr: 'Annulations et changements d’horaire' },
    'terms.cancel.p1': { en: 'Plans change, that\'s fine — just give at least 24 hours\' notice where possible so the time can go to another client.', fr: 'Les plans changent, c’est correct — donnez simplement un préavis d’au moins 24 heures lorsque possible afin que la plage horaire puisse être offerte à un autre client.' },
    'terms.guarantee.title': { en: 'Satisfaction guarantee', fr: 'Garantie de satisfaction' },
    'terms.guarantee.p1': { en: 'If you\'re not happy with a cleaning, tell me within 24 hours and I\'ll come back to fix it, free of charge.', fr: 'Si vous n’êtes pas satisfait d’un ménage, dites-le-moi dans les 24 heures et je reviendrai corriger la situation, gratuitement.' },
    'terms.uploads.title': { en: 'Photos & videos you upload', fr: 'Photos et vidéos que vous téléversez' },
    'terms.uploads.p1': { en: 'Any photos or videos you upload with a quote request are used only to help prepare an accurate quote for your home, and are never shared publicly.', fr: 'Toute photo ou vidéo téléversée avec une demande de devis est utilisée uniquement pour préparer un devis précis pour votre logement, et n’est jamais partagée publiquement.' },
    'terms.liability.title': { en: 'Care & liability', fr: 'Soin et responsabilité' },
    'terms.liability.p1': { en: 'I take care to protect your home and belongings during every visit. Please let me know in advance about fragile, high-value, or sentimental items so I can take extra precautions around them.', fr: 'Je prends soin de protéger votre maison et vos biens à chaque visite. Merci de m’aviser à l’avance des objets fragiles, de grande valeur ou sentimentaux afin que je puisse prendre des précautions supplémentaires.' },
