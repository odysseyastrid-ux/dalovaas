...
(function () {
  const STRINGS = {
    ...
    'giftcards.hero.lede': { en: 'A Magicstick Clean gift card is perfect for a housewarming, a new parent, a birthday, or just because. Request one below and we’ll take care of the rest.', fr: 'Une carte-cadeau Magicstick Clean est parfaite pour une pendaison de crémaillère, de nouveaux parents, un anniversaire, ou juste comme ça. Faites une demande ci-dessous et nous nous occupons du reste.' },
    ...
    'giftcards.how.step1.desc': { en: 'Tell us the amount and who it’s for using the form below.', fr: 'Indiquez le montant et pour qui c’est avec le formulaire ci-dessous.' },
    'giftcards.how.step2.title': { en: 'We confirm and arrange payment', fr: 'Nous confirmons et organisons le paiement' },
    'giftcards.how.step2.desc': { en: 'We’ll reach out by phone or email within a day to arrange payment and details.', fr: 'Nous vous contactons par téléphone ou courriel en moins d’une journée pour organiser le paiement et les détails.' },
