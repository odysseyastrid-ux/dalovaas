...
(function () {
  const STRINGS = {
    ...
    'a11y.skipToContent': { en: 'Skip to content', fr: 'Passer au contenu' },
    'a11y.backToTop': { en: 'Back to top', fr: 'Retour en haut' },
    'a11y.toggleDarkMode': { en: 'Toggle dark mode', fr: 'Activer le mode sombre' },
    'a11y.copy': { en: 'Copy', fr: 'Copier' },
    'a11y.showPassword': { en: 'Show password', fr: 'Afficher le mot de passe' },
    'a11y.hidePassword': { en: 'Hide password', fr: 'Masquer le mot de passe' },
    'floatingContact.call': { en: 'Call 343-843-7761', fr: 'Appeler le 343-843-7761' },
    'floatingContact.email': { en: 'Email us', fr: 'Nous écrire' },
    'floatingContact.toggle': { en: 'Contact us', fr: 'Nous contacter' },
    'cookies.bannerLabel': { en: 'Cookie notice', fr: 'Avis relatif aux témoins' },
    'cookies.text': { en: 'This site uses a few essential cookies to remember your preferences, like language and dark mode.', fr: 'Ce site utilise quelques témoins essentiels pour retenir tes préférences, comme la langue et le mode sombre.' },
    'cookies.learnMore': { en: 'Learn more', fr: 'En savoir plus' },
    'cookies.accept': { en: 'Got it', fr: "J'ai compris" },
    'confirm.defaultTitle': { en: 'Are you sure?', fr: 'Es-tu sûr(e)?' },
    'confirm.defaultConfirm': { en: 'Confirm', fr: 'Confirmer' },
    'confirm.defaultCancel': { en: 'Cancel', fr: 'Annuler' },
    'footer.newsletter.thanks': { en: "Thanks — you're on the list!", fr: 'Merci — tu es inscrit(e)!' },
    'footer.newsletter.mailSubject': { en: 'Newsletter sign-up', fr: 'Inscription à l\'infolettre' },
    'footer.newsletter.mailBody': { en: 'Please add me to the Magicstick Clean newsletter.', fr: "Ajoutez-moi à l'infolettre de Magicstick Clean, svp." },
    'footer.newsletter.title': { en: 'Stay in the loop', fr: 'Reste informé(e)' },
    'footer.newsletter.desc': { en: 'Occasional tips and seasonal offers. No spam.', fr: "Quelques conseils et offres saisonnières. Pas de pourriel." },
    ...
    'notFound.home': { en: 'Back to home', fr: "Retour à l'accueil" },
    'notFound.services': { en: 'See our services', fr: 'Voir nos services' },
    'notFound.quote': { en: 'Get a quote', fr: 'Demander un devis' },
    'common.callOrText': {
      en: 'or <a href="tel:3438437761" class="contact-link"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>call/text 343-843-7761</a> <span class="contact-sep">&middot;</span> <a href="mailto:magicstickclean@gmail.com" class="contact-link"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg>magicstickclean@gmail.com</a>',
      fr: 'ou <a href="tel:3438437761" class="contact-link"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>appelle/texte le 343-843-7761</a> <span class="contact-sep">&middot;</span> <a href="mailto:magicstickclean@gmail.com" class="contact-link"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg>magicstickclean@gmail.com</a>',
    },
    ...
    'home.hero.title': { en: '<span class="accent-word">Canada&rsquo;s</span> <span class="flag" aria-hidden="true">🇨🇦</span> most affordable, most efficient clean.', fr: 'Le nettoyage le plus abordable et le plus efficace au <span class="accent-word">Canada</span> <span class="flag" aria-hidden="true">🇨🇦</span>.' },
    ...
    'form.photos.takeCta': { en: 'Take a photo', fr: 'Prendre une photo' },
    'form.photos.takeHint': { en: 'Use your camera', fr: 'Utilise ta caméra' },
    ...
    'careers.hero.call': {
      en: '<span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>Call 343-843-7761',
      fr: '<span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>Appeler le 343-843-7761'
    },
    ...
    'careers.form.note.default': { en: 'This opens your email app with everything filled in, ready to send to <a href="mailto:magicstickclean@gmail.com" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg></span>magicstickclean@gmail.com</a>.', fr: 'Ceci ouvre ton application courriel, prête à envoyer à <a href="mailto:magicstickclean@gmail.com" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg></span>magicstickclean@gmail.com</a>.' },
    ...
    'booking.notice.backend': { en: 'Online booking isn’t turned on yet for this site. Please use the <a href="index.html#contact">quote request form</a> or call/text <a href="tel:3438437761" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>343-843-7761</a> instead.', fr: 'La réservation en ligne n’est pas encore activée sur ce site. Utilise plutôt le <a href="index.html#contact">formulaire de demande de devis</a> ou appelle/texte le <a href="tel:3438437761" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>343-843-7761</a>.' },
    ...
    'booking.confirm.title': { en: 'Confirm your booking request', fr: 'Confirmer ta demande de réservation' },
    'booking.confirm.body': { en: 'You’ll be sent to Stripe to pay a refundable deposit and lock in this date. Ready to continue?', fr: 'Tu seras redirigé vers Stripe pour payer un dépôt remboursable et réserver cette date. Prêt(e) à continuer?' },
    'booking.confirm.confirmLabel': { en: 'Continue to payment', fr: 'Continuer vers le paiement' },
    'booking.confirm.cancelLabel': { en: 'Go back', fr: 'Retour' },
    ...
    'account.email.placeholder': { en: 'Enter your email', fr: 'Entre ton courriel' },
    'account.password': { en: 'Password', fr: 'Mot de passe' },
    'account.password.placeholder': { en: 'Enter your password', fr: 'Entre ton mot de passe' },
    'account.login.submit': { en: 'Log in', fr: 'Se connecter' },
    'account.name': { en: 'Name', fr: 'Nom' },
    'account.name.placeholder': { en: 'Enter your name', fr: 'Entre ton nom' },
    'account.signup.submit': { en: 'Create account', fr: 'Créer un compte' },
    'account.rememberMe': { en: 'Remember me', fr: 'Se souvenir de moi' },
    'account.forgotPassword': { en: 'Forgot password?', fr: 'Mot de passe oublié?' },
    'account.forgotPassword.note.sent': { en: 'Password reset email sent — check your inbox.', fr: 'Courriel de réinitialisation envoyé — vérifie ta boîte de réception.' },
    'account.forgotPassword.note.needEmail': { en: 'Enter your email above first.', fr: 'Entre d’abord ton courriel ci-dessus.' },
    ...
    'quote.auth.lead': { en: 'Sign in to track this request in "My account" — or just continue as a guest.', fr: 'Connecte-toi pour suivre cette demande dans « Mon compte » — ou continue simplement comme invité.' },
    'quote.auth.continueAsGuest': { en: 'Continue as guest →', fr: 'Continuer comme invité →' },
    'quote.auth.notYou': { en: 'Not you?', fr: 'Pas toi?' },
    ...
    'admin.tab.services': { en: 'Services', fr: 'Services' },
    'admin.col.serviceName': { en: 'Name', fr: 'Nom' },
    'admin.col.category': { en: 'Category', fr: 'Catégorie' },
    'admin.col.price': { en: 'Price', fr: 'Prix' },
    'admin.col.depositCol': { en: 'Deposit', fr: 'Dépôt' },
    'admin.col.duration': { en: 'Duration', fr: 'Durée' },
    'admin.col.active': { en: 'Active', fr: 'Actif' },
    'admin.services.minutes': { en: 'min', fr: 'min' },
    'admin.services.addTitle': { en: 'Add a service', fr: 'Ajouter un service' },
    'admin.services.name': { en: 'Name (EN)', fr: 'Nom (EN)' },
    'admin.services.nameFr': { en: 'Name (FR)', fr: 'Nom (FR)' },
    'admin.services.description': { en: 'Description (EN)', fr: 'Description (EN)' },
    'admin.services.descriptionFr': { en: 'Description (FR)', fr: 'Description (FR)' },
    'admin.services.price': { en: 'Price ($)', fr: 'Prix ($)' },
    'admin.services.deposit': { en: 'Deposit ($)', fr: 'Dépôt ($)' },
    'admin.services.duration': { en: 'Duration (minutes)', fr: 'Durée (minutes)' },
    'admin.services.add': { en: 'Add service', fr: 'Ajouter le service' },
    'admin.services.added': { en: 'Service added.', fr: 'Service ajouté.' },
    ...
    'giftcards.pass.brand': { en: 'Magicstick Clean', fr: 'Magicstick Clean' },
    'giftcards.pass.label': { en: 'GIFT CARD', fr: 'CARTE-CADEAU' },
    'giftcards.pass.note': { en: 'Valid toward any Magicstick Clean service. No expiry — request yours below.', fr: 'Valide pour tout service Magicstick Clean. Sans date d’expiration — fais ta demande ci-dessous.' },
    'giftcards.pass.hint': { en: 'Hover (or tap) the card to flip it', fr: 'Survole (ou touche) la carte pour la retourner' },
    ...
    'giftcards.form.note.default': { en: 'This opens your email app with everything filled in, ready to send to <a href="mailto:magicstickclean@gmail.com" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg></span>magicstickclean@gmail.com</a>.', fr: 'Ceci ouvre votre application courriel avec tout déjà rempli, prêt à envoyer à <a href="mailto:magicstickclean@gmail.com" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg></span>magicstickclean@gmail.com</a>.' },
    ...
    'privacy.choices.p1': { en: 'You can ask to see, correct, or delete the information we have about you at any time by emailing <a href="mailto:magicstickclean@gmail.com" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg></span>magicstickclean@gmail.com</a>.', fr: 'Vous pouvez demander à voir, corriger ou supprimer les renseignements que nous détenons à votre sujet en tout temps en écrivant à <a href="mailto:magicstickclean@gmail.com" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg></span>magicstickclean@gmail.com</a>.' },
    'privacy.contact.title': { en: 'Questions?', fr: 'Des questions?' },
    'privacy.contact.p1': { en: 'Reach out any time at <a href="mailto:magicstickclean@gmail.com" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg></span>magicstickclean@gmail.com</a> or <a href="tel:3438437761" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>343-843-7761</a>.', fr: 'Écrivez-nous en tout temps à <a href="mailto:magicstickclean@gmail.com" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg></span>magicstickclean@gmail.com</a> ou au <a href="tel:3438437761" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>343-843-7761</a>.' },
    ...
    'terms.contact.p1': { en: 'Reach out any time at <a href="mailto:magicstickclean@gmail.com" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg></span>magicstickclean@gmail.com</a> or <a href="tel:3438437761" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>343-843-7761</a>.', fr: 'Écrivez-nous en tout temps à <a href="mailto:magicstickclean@gmail.com" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m2 7 10 6 10-6"/></svg></span>magicstickclean@gmail.com</a> ou au <a href="tel:3438437761" class="contact-link"><span class="contact-badge"><svg class="contact-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg></span>343-843-7761</a>.' },
