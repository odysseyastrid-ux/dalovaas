...
(function () {
  const STRINGS = {
    ...
    'cookies.text': { en: 'This site uses cookies to remember your preferences and, if you allow it, to see which ads and links bring visitors here. You choose what’s on.', fr: 'Ce site utilise des témoins pour retenir tes préférences et, si tu l’autorises, pour savoir quelles publicités et quels liens amènent des visiteurs ici. C’est toi qui décides.' },
    'cookies.learnMore': { en: 'Learn more', fr: 'En savoir plus' },
    'cookies.accept': { en: 'Accept all', fr: 'Tout accepter' },
    'cookies.reject': { en: 'Reject non-essential', fr: 'Refuser le non-essentiel' },
    'cookies.customize': { en: 'Customize', fr: 'Personnaliser' },
    'cookies.necessary.title': { en: 'Necessary', fr: 'Nécessaires' },
    'cookies.necessary.desc': { en: 'Required for the site to work — language, dark mode, staying signed in. Always on.', fr: 'Nécessaires au fonctionnement du site — langue, mode sombre, rester connecté. Toujours actifs.' },
    'cookies.alwaysOn': { en: 'Always on', fr: 'Toujours actif' },
    'cookies.analytics.title': { en: 'Analytics & marketing', fr: 'Analytique et marketing' },
    'cookies.analytics.desc': { en: 'Lets us see which ad or link brought you here, so we know what’s working. Off by default.', fr: 'Nous permet de voir quelle publicité ou quel lien t’a amené ici. Désactivé par défaut.' },
    'cookies.savePreferences': { en: 'Save preferences', fr: 'Enregistrer mes préférences' },
    'cookies.close': { en: 'Close', fr: 'Fermer' },
    ...
    'footer.newsletter.invalid': { en: 'Please enter a valid email address.', fr: 'Entre une adresse courriel valide.' },
    ...
    'zone.desc1': { en: 'So we can give you accurate scheduling and pricing.', fr: 'Pour te donner un horaire et un prix précis.' },
    ...
    'splash.promo': { en: 'Have your home cleaned by a pro for <strong>$37/h</strong> on your first booking', fr: 'Faites nettoyer votre maison par un pro pour <strong>37 $/h</strong> lors de votre première réservation' },
    ...
    // ---------- index.html: services ----------
    'home.services.title': { en: 'What we <span class="accent-word">offer</span>', fr: 'Ce que nous <span class="accent-word">offrons</span>' },
    ...
    'home.services.standard.price': { en: 'From $74 (first booking)', fr: 'À partir de 74$ (première réservation)' },
    ...
    'home.services.deep.price': { en: 'From $148 (first booking)', fr: 'À partir de 148$ (première réservation)' },
    ...
    'home.services.airbnb.price': { en: 'From $55.50 (first booking)', fr: 'À partir de 55,50$ (première réservation)' },
    ...
    'home.how.step1.title': { en: 'Reach out', fr: 'Contacte-nous' },
    ...
    'home.how.step3.desc': { en: 'Pick a day that works for you, and we’ll take care of the rest.', fr: 'Choisis une journée qui te convient, nous nous occupons du reste.' },
    ...
    'home.why.item3': { en: 'We bring our own eco-friendly supplies', fr: 'Nous apportons nos propres produits écologiques' },
    'home.why.item4': { en: 'Locally owned and operated', fr: 'Entreprise locale, propriété locale' },
    'home.why.item5': { en: 'Not happy? We’ll come back and make it right, free', fr: 'Pas satisfait? Nous revenons gratuitement pour corriger le tout' },
    'home.why.aboutLink': { en: 'Want to know more about who’s behind the mop? <a href="about.html">Read our story &rarr;</a>', fr: 'Tu veux savoir qui est derrière la vadrouille? <a href="about.html">Découvre notre histoire &rarr;</a>' },
    ...
    'home.faq.a3': { en: 'Yes, eco-friendly supplies and equipment are included at no extra cost. If you’d prefer we use products you already have, just let us know.', fr: 'Oui, les produits écologiques et l’équipement sont inclus sans frais supplémentaires. Si tu préfères que nous utilisions tes propres produits, dis-le-nous simplement.' },
    'home.faq.q4': { en: 'What if I’m not happy with the clean?', fr: 'Et si je ne suis pas satisfait du nettoyage?' },
    'home.faq.a4': { en: 'Tell us within 24 hours and we’ll come back to fix it, free of charge. Getting it right matters more than getting it done fast.', fr: 'Avise-nous dans les 24 heures et nous revenons corriger le tout, gratuitement. Bien faire les choses compte plus que les faire vite.' },
    ...
    'home.faq.a7': { en: 'Of course. Just let us know what pets are home so we can plan around them. For everyone’s safety, aggressive or very anxious pets are best kept in another room during the visit.', fr: 'Bien sûr. Dis-nous simplement quels animaux sont à la maison pour que nous puissions nous organiser. Pour la sécurité de tous, les animaux agressifs ou très anxieux sont mieux gardés dans une autre pièce pendant la visite.' },
    ...
    'home.contact.subtitle': { en: 'Fill this in and we’ll get back to you the same day.', fr: 'Remplis ce formulaire et nous te répondons le jour même.' },
    ...
    'form.address.placeholder': { en: 'Street, city, postal code', fr: 'Rue, ville, code postal' },
    ...
    'form.frequency.hint.oneTime': { en: 'Standard rate: $43.50/h. New clients get their first clean at $37/h.', fr: 'Tarif standard : 43,50 $/h. Les nouveaux clients ont leur premier ménage à 37 $/h.' },
    'form.frequency.hint.monthly': { en: '$39.15/h — a fixed monthly slot lets us plan ahead and send the same cleaner.', fr: '39,15 $/h — une plage fixe chaque mois nous permet de planifier et d’envoyer la même personne.' },
    'form.frequency.hint.biweekly': { en: '$39.15/h — your home never falls far behind, so each visit goes faster.', fr: '39,15 $/h — ta maison ne prend jamais de retard, donc chaque visite va plus vite.' },
    'form.frequency.hint.weekly': { en: '$36.98/h — pure upkeep every week, which is why it gets our biggest discount.', fr: '36,98 $/h — du pur entretien chaque semaine, d’où notre plus gros rabais.' },
    'form.frequency.compareLink': { en: 'Why these discounts?', fr: 'Pourquoi ces rabais?' },
    'pricing.title': { en: 'Clean more often, pay less per hour', fr: 'Plus c’est régulier, moins c’est cher' },
    'pricing.subtitle': { en: 'Every visit starts at our standard rate of $43.50/h. The more regular your cleanings, the less work each one takes — and we pass that saving on to you.', fr: 'Chaque visite part de notre tarif standard de 43,50 $/h. Plus tes ménages sont réguliers, moins chaque visite demande de travail — et nous te faisons profiter de cette économie.' },
    'pricing.oneTime.name': { en: 'One-time', fr: 'Une seule fois' },
    'pricing.oneTime.badge': { en: 'Standard rate', fr: 'Tarif standard' },
    'pricing.oneTime.rate': { en: '$43.50/h', fr: '43,50 $/h' },
    'pricing.oneTime.why': { en: 'A one-off visit usually means more built-up dirt and a home we’re seeing for the first time, so each room takes longer. That’s why it’s billed at our full rate.', fr: 'Une visite ponctuelle veut souvent dire plus de saleté accumulée et une maison que nous découvrons, donc chaque pièce prend plus de temps. C’est pourquoi elle est facturée au plein tarif.' },
    'pricing.monthly.name': { en: 'Monthly', fr: 'Mensuel' },
    'pricing.monthly.badge': { en: '10% off', fr: '10% de rabais' },
    'pricing.monthly.rate': { en: '$39.15/h', fr: '39,15 $/h' },
    'pricing.monthly.why': { en: 'A fixed monthly slot lets us plan our schedule ahead and send the same cleaner every time. A month is long enough for dust to build up, but your commitment still earns 10% off.', fr: 'Une plage fixe chaque mois nous permet de planifier notre horaire à l’avance et d’envoyer la même personne à chaque fois. En un mois, la poussière a le temps de s’accumuler, mais ton engagement te vaut quand même 10% de rabais.' },
    'pricing.biweekly.name': { en: 'Biweekly', fr: 'Aux deux semaines' },
    'pricing.biweekly.badge': { en: '10% off', fr: '10% de rabais' },
    'pricing.biweekly.rate': { en: '$39.15/h', fr: '39,15 $/h' },
    'pricing.biweekly.why': { en: 'Every two weeks, your home never falls far behind. Visits go faster because we’re maintaining, not catching up — a good balance of budget and cleanliness for most busy households.', fr: 'Aux deux semaines, ta maison ne prend jamais beaucoup de retard. Les visites vont plus vite parce que nous entretenons au lieu de rattraper — un bon équilibre entre budget et propreté pour la plupart des familles occupées.' },
    'pricing.weekly.name': { en: 'Weekly', fr: 'Hebdomadaire' },
    'pricing.weekly.badge': { en: '15% off', fr: '15% de rabais' },
    'pricing.weekly.rate': { en: '$36.98/h', fr: '36,98 $/h' },
    'pricing.weekly.why': { en: 'Your home stays clean all the time, so every visit is pure upkeep. Less work per visit and a guaranteed weekly spot on our calendar earn you our biggest discount.', fr: 'Ta maison reste propre en tout temps, donc chaque visite est du pur entretien. Moins de travail par visite et une place garantie chaque semaine dans notre horaire te donnent notre plus gros rabais.' },
    'pricing.note': { en: '<strong>New client?</strong> Your very first clean is $37/h (15% welcome offer), whatever frequency you pick. Your frequency rate applies from your second visit — discounts don’t stack. <a href="quote.html">Get a free quote &rarr;</a>', fr: '<strong>Nouveau client?</strong> Ton tout premier ménage est à 37 $/h (offre de bienvenue de 15%), peu importe la fréquence choisie. Ton tarif selon la fréquence s’applique dès ta deuxième visite — les rabais ne se cumulent pas. <a href="quote.html">Obtenir un devis gratuit &rarr;</a>' },
    ...
    'form.message': { en: 'Anything else we should know? (optional)', fr: 'Autre chose à savoir? (optionnel)' },
    ...
    'mail.label.address': { en: 'Address', fr: 'Adresse' },
    ...
    'halfbath.suffix': { en: 'half-bath', fr: 's. d’eau' },
    ...
    'careers.form.note.default': { en: 'Your application goes straight to our team — we reply by phone or email.', fr: 'Ta candidature est envoyée directement à notre équipe — nous te répondons par téléphone ou courriel.' },
    'careers.form.note.sending': { en: 'Sending…', fr: 'Envoi…' },
    'careers.form.note.sent': { en: 'Thanks! Your application was sent. We’ll get back to you soon.', fr: 'Merci! Ta candidature a été envoyée. Nous te revenons rapidement.' },
    ...
    'booking.form.notes': { en: 'Anything we should know? (optional)', fr: 'Autre chose à savoir? (optionnel)' },
    'booking.form.notesPlaceholder': { en: 'Home size, access instructions, pets...', fr: 'Taille du logement, accès, animaux...' },
    'booking.form.submit': { en: 'Continue to payment', fr: 'Continuer vers le paiement' },
    'booking.form.submitGift': { en: 'Confirm booking', fr: 'Confirmer la réservation' },
    'booking.gift.noPaymentNote': { en: 'Your gift card covers today’s deposit — nothing to pay online.', fr: 'Ta carte-cadeau couvre le dépôt d’aujourd’hui — rien à payer en ligne.' },
    'booking.gift.label': { en: 'Gift card', fr: 'Carte-cadeau' },
    'booking.gift.apply': { en: 'Apply', fr: 'Appliquer' },
    'booking.gift.checking': { en: 'Checking…', fr: 'Vérification…' },
    'booking.gift.valid': { en: 'Gift card applied — ${balance} available.', fr: 'Carte-cadeau appliquée — {balance}$ disponible.' },
    'booking.gift.invalid': { en: 'This gift card code isn’t valid or has no balance left.', fr: 'Ce code de carte-cadeau n’est pas valide ou n’a plus de solde.' },
    'booking.gift.tooMany': { en: 'Too many attempts — please try again in a little while.', fr: 'Trop de tentatives — réessaie dans un moment.' },
    'booking.gift.error': { en: 'Couldn’t check the code right now. Please try again.', fr: 'Impossible de vérifier le code pour le moment. Réessaie.' },
    'booking.gift.summary': { en: 'Gift card: −${amount}. Due today: ${today} CAD — ${later} due at the appointment.', fr: 'Carte-cadeau : −{amount}$. Dû aujourd’hui : {today}$ CAD — {later}$ dû au rendez-vous.' },
    'booking.payment.gift': { en: 'Gift card: −${amount} CAD', fr: 'Carte-cadeau : −{amount}$ CAD' },
    'booking.form.note.default': { en: 'You’ll pay a refundable deposit securely on this page. The rest is due at your appointment.', fr: 'Tu paieras un dépôt remboursable en toute sécurité sur cette page. Le solde est dû au rendez-vous.' },
    ...
    'booking.form.note.settingUp': { en: 'Setting up secure payment...', fr: 'Préparation du paiement sécurisé...' },
    ...
    'booking.form.note.stripeUnavailable': { en: 'Online payment isn’t available right now. Please call/text 343-843-7761 to book.', fr: 'Le paiement en ligne n’est pas disponible pour le moment. Appelle/texte le 343-843-7761 pour réserver.' },
    'booking.confirm.title': { en: 'Confirm your booking request', fr: 'Confirmer ta demande de réservation' },
    'booking.confirm.body': { en: 'You’ll pay a refundable deposit on this page to lock in this date. Ready to continue?', fr: 'Tu paieras un dépôt remboursable sur cette page pour réserver cette date. Prêt(e) à continuer?' },
    ...
    'booking.firstBooking.note': { en: 'First booking? Pay ${rate}/h instead of ${regular}/h — confirmed at checkout.', fr: 'Première réservation? Paie {rate}$/h au lieu de {regular}$/h — confirmé au paiement.' },
    'booking.firstBooking.applied': { en: 'First-booking discount applied: ${rate}/h', fr: 'Rabais première réservation appliqué : {rate}$/h' },
    'booking.payment.cardholderName': { en: 'Card holder full name', fr: 'Nom complet du titulaire' },
    'booking.payment.cardholderName.placeholder': { en: 'Enter your full name', fr: 'Entre ton nom complet' },
    'booking.payment.submit': { en: 'Pay deposit', fr: 'Payer le dépôt' },
    'booking.payment.back': { en: 'Back', fr: 'Retour' },
    'booking.payment.total': { en: 'Total price: ${total} CAD', fr: 'Prix total : {total}$ CAD' },
    'booking.payment.dueToday': { en: 'Due today: ${deposit} CAD', fr: 'Dû aujourd’hui : {deposit}$ CAD' },
    'booking.payment.dueLater': { en: 'Due at appointment: ${remaining} CAD', fr: 'Dû au rendez-vous : {remaining}$ CAD' },
    'booking.payment.note.needName': { en: 'Please enter the card holder’s name.', fr: 'Entre le nom du titulaire de la carte.' },
    'booking.payment.note.processing': { en: 'Processing payment...', fr: 'Traitement du paiement...' },
    'booking.payment.note.error': { en: 'Payment failed. Please check your card details and try again.', fr: 'Le paiement a échoué. Vérifie les infos de ta carte et réessaie.' },
    // Home size + extras (add-ons)
    'booking.size.label': { en: 'Home size', fr: 'Taille du logement' },
    'booking.size.hint': { en: 'Helps us plan the right team and time. It doesn’t change your deposit.', fr: 'Nous aide à prévoir la bonne équipe et le bon temps. Ça ne change pas ton dépôt.' },
    'booking.size.bedrooms': { en: 'Bedrooms', fr: 'Chambres' },
    'booking.size.bathrooms': { en: 'Bathrooms', fr: 'Salles de bain' },
    'booking.size.halfBathrooms': { en: 'Half-baths', fr: 'Salles d’eau' },
    'booking.size.decrease': { en: 'Decrease', fr: 'Diminuer' },
    'booking.size.increase': { en: 'Increase', fr: 'Augmenter' },
    'booking.extras.label': { en: 'Add extras', fr: 'Ajouter des extras' },
    'booking.extras.hint': { en: 'Optional add-ons. These add to your total and are collected at the appointment — your deposit stays the same.', fr: 'Extras optionnels. Ils s’ajoutent à ton total et sont perçus au rendez-vous — ton dépôt reste le même.' },
    'booking.extras.each': { en: '${price} each', fr: '{price}$ chacun' },
    'booking.extras.perWindow': { en: '${price} / window', fr: '{price}$ / fenêtre' },
    'booking.extras.perRoom': { en: '${price} / room', fr: '{price}$ / pièce' },
    'booking.extras.perLoad': { en: '${price} / load', fr: '{price}$ / brassée' },
    'booking.extras.perHour': { en: '${price} / hour', fr: '{price}$ / heure' },
    'booking.extras.summary': { en: 'Extras: +${amount} CAD (collected at the appointment)', fr: 'Extras : +{amount}$ CAD (perçus au rendez-vous)' },
    'booking.extras.total': { en: 'New total: ${total} CAD', fr: 'Nouveau total : {total}$ CAD' },
    ...
    'account.resetPassword.title': { en: 'Set a new password', fr: 'Choisis un nouveau mot de passe' },
    'account.resetPassword.new': { en: 'New password', fr: 'Nouveau mot de passe' },
    'account.resetPassword.confirm': { en: 'Confirm new password', fr: 'Confirme le nouveau mot de passe' },
    'account.resetPassword.confirm.placeholder': { en: 'Re-enter your password', fr: 'Ressaisis ton mot de passe' },
    'account.resetPassword.submit': { en: 'Set new password', fr: 'Enregistrer le mot de passe' },
    'account.resetPassword.note.saving': { en: 'Saving your new password...', fr: 'Enregistrement du nouveau mot de passe...' },
    'account.resetPassword.note.mismatch': { en: 'Those passwords don’t match.', fr: 'Les mots de passe ne correspondent pas.' },
    ...
    'account.nav.bookings': { en: 'My bookings', fr: 'Mes réservations' },
    'account.nav.quotes': { en: 'My quote requests', fr: 'Mes demandes de devis' },
    'account.nav.account': { en: 'Account', fr: 'Compte' },
    ...
    'promo.welcome.eyebrow': { en: 'New clients', fr: 'Nouveaux clients' },
    'promo.welcome.title': { en: '15% off your first clean', fr: '15% de rabais sur ton premier ménage' },
    'promo.welcome.text': { en: '$37/h instead of $43.50/h on your very first booking — applied automatically.', fr: '37 $/h au lieu de 43,50 $/h sur ta toute première réservation — appliqué automatiquement.' },
    'promo.welcome.cta': { en: 'Book online →', fr: 'Réserver en ligne →' },
    'promo.recurring.eyebrow': { en: 'Recurring savings', fr: 'Économies récurrentes' },
    'promo.recurring.title': { en: 'Up to 15% off every visit', fr: 'Jusqu’à 15% de rabais à chaque visite' },
    'promo.recurring.text': { en: 'Weekly: 15% off. Biweekly or monthly: 10% off. The more regular, the less each visit costs.', fr: 'Hebdomadaire : 15% de rabais. Aux deux semaines ou mensuel : 10% de rabais. Plus c’est régulier, moins chaque visite coûte.' },
    'promo.recurring.cta': { en: 'How our discounts work →', fr: 'Comment fonctionnent nos rabais →' },
    'promo.book.eyebrow': { en: 'Skip the wait', fr: 'Sans attente' },
    'promo.book.title': { en: 'Book online in minutes', fr: 'Réserve en ligne en quelques minutes' },
    'promo.book.text': { en: 'Standard, deep or Airbnb cleaning: pick your day and pay a small deposit online. No quote needed.', fr: 'Nettoyage standard, en profondeur ou Airbnb : choisis ta journée et paie un petit dépôt en ligne. Aucun devis nécessaire.' },
    'promo.book.cta': { en: 'Book now →', fr: 'Réserver →' },
    'promo.gift.eyebrow': { en: 'Gift cards', fr: 'Cartes-cadeaux' },
    'promo.gift.title': { en: 'Give a spotless home', fr: 'Offre une maison impeccable' },
    'promo.gift.text': { en: 'Perfect for a housewarming, new parents or a birthday.', fr: 'Parfait pour une pendaison de crémaillère, de nouveaux parents ou un anniversaire.' },
    'promo.gift.cta': { en: 'Get a gift card →', fr: 'Obtenir une carte-cadeau →' },
    ...
    'admin.tab.extras': { en: 'Extras', fr: 'Extras' },
    'admin.col.extra': { en: 'Extra', fr: 'Extra' },
    'admin.col.unit': { en: 'Unit', fr: 'Unité' },
    'admin.extras.unit.flat': { en: 'Flat (once)', fr: 'Forfait (une fois)' },
    'admin.extras.unit.window': { en: 'Per window', fr: 'Par fenêtre' },
    'admin.extras.unit.room': { en: 'Per room', fr: 'Par pièce' },
    'admin.extras.unit.load': { en: 'Per load', fr: 'Par brassée' },
    'admin.extras.unit.hour': { en: 'Per hour', fr: 'Par heure' },
    'admin.extras.addTitle': { en: 'Add an extra', fr: 'Ajouter un extra' },
    'admin.extras.name': { en: 'Name (EN)', fr: 'Nom (EN)' },
    'admin.extras.nameFr': { en: 'Name (FR)', fr: 'Nom (FR)' },
    'admin.extras.unit': { en: 'Unit', fr: 'Unité' },
    'admin.extras.price': { en: 'Price ($)', fr: 'Prix ($)' },
    'admin.extras.add': { en: 'Add extra', fr: 'Ajouter l’extra' },
    'admin.extras.added': { en: 'Extra added.', fr: 'Extra ajouté.' },
    'admin.extras.invalid': { en: 'Please enter a name and a valid unit.', fr: 'Entre un nom et une unité valide.' },
    'admin.logout': { en: 'Log out', fr: 'Se déconnecter' },
    'admin.dash.title': { en: 'Dashboard', fr: 'Tableau de bord' },
    'admin.dash.nav.dashboard': { en: 'Dashboard', fr: 'Tableau de bord' },
    'admin.dash.nav.overview': { en: 'Overview', fr: "Vue d'ensemble" },
    'admin.dash.nav.operations': { en: 'Operations', fr: 'Opérations' },
    'admin.dash.nav.calendar': { en: 'Calendar & bookings', fr: 'Calendrier & réservations' },
    'admin.dash.nav.crm': { en: 'Quotes, bookings & services', fr: 'Devis, réservations & services' },
    'admin.dash.nav.notifications': { en: 'Notifications', fr: 'Notifications' },
    'admin.dash.nav.marketing': { en: 'Marketing', fr: 'Marketing' },
    'admin.dash.nav.localResearch': { en: 'Local research', fr: 'Recherche locale' },
    'admin.dash.nav.contentMarketing': { en: 'Content marketing', fr: 'Marketing de contenu' },
    'admin.dash.nav.localMarketing': { en: 'Local marketing', fr: 'Marketing local' },
    'admin.dash.nav.seo': { en: 'SEO', fr: 'SEO' },
    'admin.dash.nav.smm': { en: 'Social media (SMM)', fr: 'Réseaux sociaux (SMM)' },
    'admin.dash.nav.ads': { en: 'Ads & site banners', fr: 'Publicités & bannières' },
    'admin.dash.nav.aiTools': { en: 'AI & reports', fr: 'IA & rapports' },
    'admin.dash.nav.aiResearch': { en: 'AI research', fr: 'Recherche IA' },
    'admin.dash.nav.reportGenerator': { en: 'Report generator', fr: 'Générateur de rapports' },
    'admin.dash.nav.agencyPack': { en: 'Agency pack', fr: 'Pack agence' },
    'admin.dash.nav.system': { en: 'System', fr: 'Système' },
    'admin.dash.nav.files': { en: 'Files', fr: 'Fichiers' },
    'admin.dash.nav.api': { en: 'API', fr: 'API' },
    'admin.dash.nav.backups': { en: 'Backups', fr: 'Sauvegardes' },
    'admin.dash.nav.audits': { en: 'Audits', fr: 'Audits' },
    'admin.dash.notifications': { en: 'Notifications', fr: 'Notifications' },
    'admin.dash.notifEmpty': { en: 'No notifications yet.', fr: 'Aucune notification pour le moment.' },
    'admin.dash.overview.trend': { en: 'Revenue trend', fr: 'Tendance des revenus' },
    'admin.dash.overview.activity': { en: 'Recent activity', fr: 'Activité récente' },
    'admin.dash.kpi.revenue': { en: 'Revenue (this month)', fr: 'Revenus (ce mois-ci)' },
    'admin.dash.kpi.bookings': { en: 'Upcoming bookings', fr: 'Réservations à venir' },
    'admin.dash.kpi.leads': { en: 'Leads (this month)', fr: 'Prospects (ce mois-ci)' },
    'admin.dash.kpi.rating': { en: 'Average rating', fr: 'Note moyenne' },
    'admin.dash.reviews': { en: 'reviews', fr: 'avis' },
    'admin.dash.keyword': { en: 'Keyword', fr: 'Mot-clé' },
    'admin.dash.position': { en: 'Position', fr: 'Position' },
    'admin.dash.change': { en: 'Change', fr: 'Variation' },
    'admin.dash.volume': { en: 'Volume', fr: 'Volume' },
    'admin.dash.status': { en: 'Status', fr: 'Statut' },
    'admin.dash.note': { en: 'Note', fr: 'Note' },
    'admin.dash.date': { en: 'Date', fr: 'Date' },
    'admin.dash.platform': { en: 'Platform', fr: 'Plateforme' },
    'admin.dash.listing': { en: 'Listing', fr: 'Répertoire' },
    'admin.dash.ok': { en: 'Good', fr: 'Bon' },
    'admin.dash.attention': { en: 'Needs attention', fr: 'À corriger' },
    'admin.dash.copy': { en: 'Copy', fr: 'Copier' },
    'admin.dash.copied': { en: 'Copied!', fr: 'Copié!' },
    'admin.dash.toggle': { en: 'Toggle', fr: 'Basculer' },
    'admin.dash.connected': { en: 'Connected', fr: 'Connecté' },
    'admin.dash.notConnected': { en: 'Not connected', fr: 'Non connecté' },
    'admin.dash.followers': { en: 'followers', fr: 'abonnés' },
    'admin.dash.confirmed': { en: 'Confirmed', fr: 'Confirmé' },
    'admin.dash.manualBackup': { en: 'Manual backup', fr: 'Sauvegarde manuelle' },
    'admin.dash.justNow': { en: 'Just now', fr: "À l'instant" },
    'admin.dash.newOrderSim': { en: 'New booking request', fr: 'Nouvelle demande de réservation' },
    'admin.dash.newPaySim': { en: 'Payment proof received', fr: 'Preuve de paiement reçue' },
    'admin.dash.simOrder': { en: 'Simulate new order', fr: 'Simuler une nouvelle commande' },
    'admin.dash.simPay': { en: 'Simulate payment proof', fr: 'Simuler une preuve de paiement' },
    'admin.dash.markAllRead': { en: 'Mark all read', fr: 'Tout marquer comme lu' },
    'admin.dash.viewReport': { en: 'View report', fr: 'Voir le rapport' },
    'admin.dash.cal.mon': { en: 'Mon', fr: 'Lun' },
    'admin.dash.cal.tue': { en: 'Tue', fr: 'Mar' },
    'admin.dash.cal.wed': { en: 'Wed', fr: 'Mer' },
    'admin.dash.cal.thu': { en: 'Thu', fr: 'Jeu' },
    'admin.dash.cal.fri': { en: 'Fri', fr: 'Ven' },
    'admin.dash.cal.sat': { en: 'Sat', fr: 'Sam' },
    'admin.dash.cal.sun': { en: 'Sun', fr: 'Dim' },
    'admin.dash.cal.more': { en: 'more', fr: 'de plus' },
    'admin.dash.cal.noBookings': { en: 'No bookings this day.', fr: 'Aucune réservation ce jour.' },
    'admin.dash.localResearch.keywords': { en: 'Local keyword opportunities', fr: "Opportunités de mots-clés locaux" },
    'admin.dash.localResearch.competitors': { en: 'Nearby competitors', fr: 'Concurrents à proximité' },
    'admin.dash.content.add': { en: 'Add idea', fr: 'Ajouter une idée' },
    'admin.dash.content.idea': { en: 'Idea', fr: 'Idée' },
    'admin.dash.content.drafting': { en: 'Drafting', fr: 'En rédaction' },
    'admin.dash.content.scheduled': { en: 'Scheduled', fr: 'Planifié' },
    'admin.dash.content.published': { en: 'Published', fr: 'Publié' },
    'admin.dash.localMarketing.title': { en: 'Local listings & citations', fr: 'Répertoires locaux & citations' },
    'admin.dash.localMarketing.sub': { en: 'Where Magicstick Clean shows up across local directories.', fr: 'Où Magicstick Clean apparaît dans les répertoires locaux.' },
    'admin.dash.seo.traffic': { en: 'Traffic & leads', fr: 'Trafic & prospects' },
    'admin.dash.seo.score': { en: 'SEO score', fr: 'Score SEO' },
    'admin.dash.seo.keywords': { en: 'Keyword rankings', fr: 'Classement des mots-clés' },
    'admin.dash.seo.issues': { en: 'Technical issues', fr: 'Problèmes techniques' },
    'admin.dash.seo.sessions': { en: 'Sessions', fr: 'Sessions' },
    'admin.dash.seo.leads': { en: 'Leads', fr: 'Prospects' },
    'admin.dash.smm.accounts': { en: 'Connected accounts', fr: 'Comptes connectés' },
    'admin.dash.smm.queue': { en: 'Content queue', fr: 'File de contenu' },
    'admin.dash.smm.post': { en: 'Post', fr: 'Publication' },
    'admin.dash.smm.schedule': { en: 'Add to queue', fr: 'Ajouter à la file' },
    'admin.dash.ads.title': { en: 'Site ads & banners', fr: 'Publicités & bannières du site' },
    'admin.dash.ads.sub': { en: 'Toggle promotional banners and animated call-outs across the site.', fr: 'Active ou désactive les bannières promotionnelles et animations du site.' },
    'admin.dash.ai.title': { en: 'AI research & content assistant', fr: 'Recherche IA & assistant de contenu' },
    'admin.dash.ai.sub': { en: 'Draft ideas locally today — connect a real Claude API key under Settings → API to generate live.', fr: "Génère des ébauches localement pour l'instant — connecte une vraie clé API Claude dans API pour générer en direct." },
    'admin.dash.ai.topic': { en: 'Topic', fr: 'Sujet' },
    'admin.dash.ai.generate': { en: 'Generate draft', fr: 'Générer une ébauche' },
    'admin.dash.ai.output': { en: 'Draft', fr: 'Ébauche' },
    'admin.dash.report.title': { en: 'Report generator', fr: 'Générateur de rapports' },
    'admin.dash.report.sub': { en: "Builds a printable summary from your current dashboard data — use your browser's Print dialog to save as PDF.", fr: "Génère un résumé imprimable à partir des données actuelles — utilise l'impression du navigateur pour l'enregistrer en PDF." },
    'admin.dash.report.generate': { en: 'Generate monthly report', fr: 'Générer le rapport mensuel' },
    'admin.dash.nav.giftCards': { en: 'Gift cards', fr: 'Cartes-cadeaux' },
    'admin.gift.cardsTitle': { en: 'Gift cards', fr: 'Cartes-cadeaux' },
    'admin.gift.cardsSub': { en: 'Every card sold online or issued by you, with what’s left on it.', fr: 'Toutes les cartes vendues en ligne ou émises par vous, avec leur solde.' },
    'admin.gift.col.code': { en: 'Code', fr: 'Code' },
    'admin.gift.col.amount': { en: 'Amount', fr: 'Montant' },
    'admin.gift.col.balance': { en: 'Balance', fr: 'Solde' },
    'admin.gift.col.recipient': { en: 'Recipient', fr: 'Destinataire' },
    'admin.gift.col.buyer': { en: 'Buyer', fr: 'Acheteur' },
    'admin.gift.col.source': { en: 'Source', fr: 'Source' },
    'admin.gift.empty': { en: 'No gift cards yet.', fr: 'Aucune carte-cadeau pour le moment.' },
    'admin.gift.source.online': { en: 'Sold online', fr: 'Vendue en ligne' },
    'admin.gift.source.manual': { en: 'Issued by you', fr: 'Émise par vous' },
    'admin.gift.status.active': { en: 'Active', fr: 'Active' },
    'admin.gift.status.void': { en: 'Void', fr: 'Annulée' },
    'admin.gift.status.pending_payment': { en: 'Awaiting payment', fr: 'Paiement en attente' },
    'admin.gift.void': { en: 'Void card', fr: 'Annuler la carte' },
    'admin.gift.voidConfirmTitle': { en: 'Void this gift card?', fr: 'Annuler cette carte-cadeau?' },
    'admin.gift.voidConfirmBody': { en: '{code} will stop working immediately. Its remaining {balance} can no longer be used. Refunds, if any, are handled separately.', fr: '{code} cessera de fonctionner immédiatement. Son solde restant de {balance} ne pourra plus être utilisé. Les remboursements, s’il y a lieu, se font séparément.' },
    'admin.gift.issueTitle': { en: 'Issue a gift card', fr: 'Émettre une carte-cadeau' },
    'admin.gift.issueSub': { en: 'For cards paid by e-transfer or cash, or given as a gesture. A unique code is generated and emailed automatically.', fr: 'Pour les cartes payées par virement ou en argent, ou offertes. Un code unique est généré et envoyé par courriel automatiquement.' },
    'admin.gift.amount': { en: 'Amount ($)', fr: 'Montant ($)' },
    'admin.gift.recipientName': { en: 'Recipient’s name', fr: 'Nom du destinataire' },
    'admin.gift.recipientEmail': { en: 'Recipient’s email', fr: 'Courriel du destinataire' },
    'admin.gift.buyerName': { en: 'Buyer’s name (optional)', fr: 'Nom de l’acheteur (optionnel)' },
    'admin.gift.buyerEmail': { en: 'Buyer’s email (optional — gets a copy)', fr: 'Courriel de l’acheteur (optionnel — reçoit une copie)' },
    'admin.gift.message': { en: 'Message (optional)', fr: 'Message (optionnel)' },
    'admin.gift.lang': { en: 'Email language', fr: 'Langue du courriel' },
    'admin.gift.sendEmail': { en: 'Email the gift card now', fr: 'Envoyer la carte-cadeau par courriel maintenant' },
    'admin.gift.issueSubmit': { en: 'Issue gift card', fr: 'Émettre la carte-cadeau' },
    'admin.gift.requestsTitle': { en: 'Gift card requests', fr: 'Demandes de cartes-cadeaux' },
    'admin.gift.requestsSub': { en: 'Sent through the request form (to pay by e-transfer). Once paid, click “Issue card” to create and send it.', fr: 'Envoyées via le formulaire de demande (paiement par virement). Une fois payée, cliquez sur « Émettre » pour la créer et l’envoyer.' },
    'admin.gift.requestsEmpty': { en: 'No requests yet.', fr: 'Aucune demande pour le moment.' },
    'admin.gift.issueFromRequest': { en: 'Issue card', fr: 'Émettre' },
    'admin.gift.fromRequestNote': { en: 'Filled in from {name}’s request — check the details, then issue.', fr: 'Rempli à partir de la demande de {name} — vérifiez les détails, puis émettez.' },
    'admin.gift.amountErr': { en: 'Enter a whole-dollar amount between $5 and $2,000.', fr: 'Entrez un montant en dollars entiers entre 5 $ et 2 000 $.' },
    'admin.gift.issuing': { en: 'Creating the gift card…', fr: 'Création de la carte-cadeau…' },
    'admin.gift.issuedSent': { en: 'Done! {code} is active and was emailed to {email}.', fr: 'C’est fait! {code} est active et a été envoyée à {email}.' },
    'admin.gift.issued': { en: 'Done! {code} is active. Share the code with the recipient.', fr: 'C’est fait! {code} est active. Transmettez le code à la personne.' },
    'admin.gift.issueError': { en: 'Couldn’t issue the gift card. Please try again.', fr: 'Impossible d’émettre la carte-cadeau. Réessayez.' },
    'admin.gift.bookingLine': { en: 'Gift card −${amount}', fr: 'Carte-cadeau −{amount}$' },
    'admin.dash.pack.title': { en: 'Agency pack', fr: 'Pack agence' },
    'admin.dash.pack.sub': { en: 'Ready-made marketing collateral you can hand to a partner or print for a client.', fr: 'Matériel marketing prêt à partager avec un partenaire ou à imprimer pour un client.' },
    'admin.dash.pack.mediaKit': { en: 'Open media kit', fr: 'Ouvrir la trousse média' },
    'admin.dash.api.title': { en: 'API access', fr: 'Accès API' },
    'admin.dash.api.sub': { en: "Placeholder key — wire this to your real backend once it's provisioned.", fr: 'Clé provisoire — à connecter à ton vrai backend une fois provisionné.' },
    'admin.dash.api.regenerate': { en: 'Regenerate', fr: 'Régénérer' },
    'admin.dash.files.title': { en: 'File manager', fr: 'Gestionnaire de fichiers' },
    'admin.dash.files.drop': { en: 'Drag files here, or click to browse', fr: 'Glisse des fichiers ici, ou clique pour parcourir' },
    'admin.dash.files.empty': { en: 'No files yet.', fr: 'Aucun fichier pour le moment.' },
    'admin.dash.backups.title': { en: 'Backups', fr: 'Sauvegardes' },
    'admin.dash.backups.now': { en: 'Back up now', fr: 'Sauvegarder maintenant' },
    'admin.dash.backups.sub': { en: "Exports the dashboard's current data as a JSON file you can keep offline.", fr: 'Exporte les données actuelles du tableau de bord en fichier JSON que tu peux garder hors ligne.' },
    'admin.dash.audits.title': { en: 'Audits', fr: 'Audits' },
    ...
    'about.hero.lede': { en: 'Locally owned and run by hand, not by a call center — when you book with us, you get the same cleaner every time.', fr: 'Une entreprise locale, gérée à la main, pas par un centre d’appels — quand vous réservez avec nous, vous avez la même personne à chaque visite.' },
    'about.story.title': { en: 'Why we started Magicstick Clean', fr: 'Pourquoi nous avons fondé Magicstick Clean' },
    'about.story.p1': { en: 'We started Magicstick Clean because we were tired of seeing cleaning done the impersonal way: a different face every visit, a call center between you and the person in your home, and no one you could really reach if something wasn’t right.', fr: 'Nous avons fondé Magicstick Clean parce que nous en avions assez de voir le ménage fait de façon impersonnelle : un visage différent à chaque visite, un centre d’appels entre vous et la personne dans votre maison, et personne à joindre vraiment si quelque chose n’allait pas.' },
    'about.story.p2': { en: 'So we built something smaller and more personal: one cleaner you can count on, eco-friendly supplies we bring ourselves, and a direct line to the owner for anything you need, from Clarence-Rockland to Ottawa and across the river into Gatineau.', fr: 'Nous avons donc bâti quelque chose de plus petit et de plus personnel : une seule personne sur qui compter, des produits écologiques que nous apportons nous-mêmes, et une ligne directe avec la propriétaire pour tout ce dont vous avez besoin, de Clarence-Rockland à Ottawa, jusqu’à Gatineau.' },
    ...
    'about.values.item3': { en: 'Eco-friendly supplies, brought by us', fr: 'Produits écologiques, apportés par nous' },
    'about.values.item4': { en: 'Locally owned and operated', fr: 'Propriété locale et gestion locale' },
    'about.values.item5': { en: 'Not happy? We’ll come back and make it right, free', fr: 'Pas satisfait? Nous revenons tout arranger, gratuitement' },
    ...
    'giftcards.hero.lede': { en: 'A Magicstick Clean gift card is perfect for a housewarming, a new parent, a birthday, or just because. Buy one online in a minute — it arrives by email with its own code.', fr: 'Une carte-cadeau Magicstick Clean est parfaite pour une pendaison de crémaillère, de nouveaux parents, un anniversaire, ou juste comme ça. Achetez-la en ligne en une minute — elle arrive par courriel avec son propre code.' },
    'giftcards.pass.brand': { en: 'Magicstick Clean', fr: 'Magicstick Clean' },
    'giftcards.pass.label': { en: 'GIFT CARD', fr: 'CARTE-CADEAU' },
    'giftcards.pass.note': { en: 'Valid toward any Magicstick Clean service. Never expires.', fr: 'Valide pour tout service Magicstick Clean. N’expire jamais.' },
    ...
    'giftcards.how.step1.title': { en: 'Choose an amount', fr: 'Choisissez un montant' },
    'giftcards.how.step1.desc': { en: 'Pick $50, $100, $150, $200 or any amount from $25 to $1,000, and who it’s for.', fr: 'Choisissez 50 $, 100 $, 150 $, 200 $ ou tout montant de 25 $ à 1 000 $, et pour qui c’est.' },
    'giftcards.how.step2.title': { en: 'Pay securely', fr: 'Payez en toute sécurité' },
    'giftcards.how.step2.desc': { en: 'Pay online on this page in under a minute — or send us a request and pay by e-transfer.', fr: 'Payez en ligne sur cette page en moins d’une minute — ou envoyez-nous une demande et payez par virement Interac.' },
    'giftcards.how.step3.title': { en: 'They book with the code', fr: 'La personne réserve avec le code' },
    'giftcards.how.step3.desc': { en: 'The recipient gets a unique code by email and enters it when booking. Any unused balance stays on the card, and it never expires.', fr: 'La personne reçoit un code unique par courriel et l’entre en réservant. Le solde non utilisé reste sur la carte, et elle n’expire jamais.' },
    'giftcards.form.title': { en: 'Request a gift card', fr: 'Demander une carte-cadeau' },
    'giftcards.form.subtitle': { en: 'Fill this in and we’ll get back to you the same day.', fr: 'Remplissez ce formulaire et nous vous répondons le jour même.' },
    'giftcards.form.payOnline': { en: 'Pay online instead', fr: 'Payer en ligne plutôt' },
    'giftcards.buy.fixFields': { en: 'Please check the highlighted fields.', fr: 'Vérifiez les champs en surbrillance.' },
    'giftcards.buy.title': { en: 'Buy a gift card', fr: 'Acheter une carte-cadeau' },
    'giftcards.buy.subtitle': { en: 'Pay securely on this page — the gift card and its code arrive by email right away.', fr: 'Payez en toute sécurité sur cette page — la carte-cadeau et son code arrivent par courriel immédiatement.' },
    'giftcards.buy.customAmount': { en: 'Other amount', fr: 'Autre montant' },
    'giftcards.buy.customPlaceholder': { en: '25 – 1000', fr: '25 – 1000' },
    'giftcards.buy.amountErr': { en: 'Choose an amount between $25 and $1,000.', fr: 'Choisissez un montant entre 25 $ et 1 000 $.' },
    'giftcards.buy.yourName': { en: 'Your name', fr: 'Votre nom' },
    'giftcards.buy.yourEmail': { en: 'Your email', fr: 'Votre courriel' },
    'giftcards.buy.deliverTo': { en: 'Send the gift card', fr: 'Envoyer la carte-cadeau' },
    'giftcards.buy.deliverRecipient': { en: 'By email to the recipient', fr: 'Par courriel à la personne' },
    'giftcards.buy.deliverMe': { en: 'To me — I’ll give it myself', fr: 'À moi — je la remettrai moi-même' },
    'giftcards.buy.recipientName': { en: 'Recipient’s name', fr: 'Nom de la personne' },
    'giftcards.buy.recipientEmail': { en: 'Recipient’s email', fr: 'Courriel de la personne' },
    'giftcards.buy.message': { en: 'Personal message', fr: 'Message personnel' },
    'giftcards.buy.messagePlaceholder': { en: 'Happy housewarming! Enjoy a spotless home on us.', fr: 'Bonne pendaison de crémaillère! Profite d’une maison impeccable.' },
    'giftcards.buy.preferRequest': { en: 'Prefer to pay by e-transfer? Send a request instead', fr: 'Vous préférez payer par virement Interac? Envoyez plutôt une demande' },
    'giftcards.buy.submit': { en: 'Continue to payment — ${amount}', fr: 'Continuer vers le paiement — {amount}$' },
    'giftcards.buy.submitNoAmount': { en: 'Continue to payment', fr: 'Continuer vers le paiement' },
    'giftcards.buy.unavailable': { en: 'Online payment isn’t available right now — send a request below and we’ll arrange payment with you.', fr: 'Le paiement en ligne n’est pas disponible pour le moment — envoyez une demande ci-dessous et nous organiserons le paiement avec vous.' },
    'giftcards.pay.submit': { en: 'Pay now', fr: 'Payer maintenant' },
    'giftcards.pay.summaryTitle': { en: 'Magicstick Clean gift card — ${amount}', fr: 'Carte-cadeau Magicstick Clean — {amount}$' },
    'giftcards.pay.summaryRecipient': { en: 'Emailed to {email} as soon as the payment goes through.', fr: 'Envoyée par courriel à {email} dès que le paiement est accepté.' },
    'giftcards.pay.summaryMe': { en: 'Emailed to you ({email}) as soon as the payment goes through.', fr: 'Envoyée à votre courriel ({email}) dès que le paiement est accepté.' },
    'giftcards.pay.total': { en: 'Total: ${amount} CAD', fr: 'Total : {amount}$ CAD' },
    'giftcards.success.title': { en: 'Thank you!', fr: 'Merci!' },
    'giftcards.success.recipient': { en: 'Payment received. The gift card is on its way to {email}, and a copy with the code is going to {buyer}.', fr: 'Paiement reçu. La carte-cadeau s’en va à {email}, et une copie avec le code est envoyée à {buyer}.' },
    'giftcards.success.me': { en: 'Payment received. Your gift card and its code are on their way to {email} — ready to give.', fr: 'Paiement reçu. Votre carte-cadeau et son code s’en vont à {email} — prête à offrir.' },
    'giftcards.success.generic': { en: 'Payment received. The gift card and its code are on their way by email.', fr: 'Paiement reçu. La carte-cadeau et son code s’en viennent par courriel.' },
    'giftcards.balance.title': { en: 'Check your balance', fr: 'Vérifiez votre solde' },
    'giftcards.balance.desc': { en: 'Enter the code from your gift card email to see what’s left on it.', fr: 'Entrez le code de votre courriel de carte-cadeau pour voir le solde restant.' },
    'giftcards.balance.label': { en: 'Gift card code', fr: 'Code de la carte-cadeau' },
    'giftcards.balance.submit': { en: 'Check', fr: 'Vérifier' },
    'giftcards.balance.result': { en: 'Balance: ${balance} CAD — use it when you book online.', fr: 'Solde : {balance}$ CAD — utilisez-le en réservant en ligne.' },
    'giftcards.balance.unavailable': { en: 'Balance check isn’t available right now — call or text 343-843-7761.', fr: 'La vérification du solde n’est pas disponible — appelez ou textez le 343-843-7761.' },
    ...
    'giftcards.form.note.default': { en: 'Your request goes straight to our team — we’ll contact you within a day to arrange payment.', fr: 'Votre demande est envoyée directement à notre équipe — nous vous contactons en moins d’une journée pour organiser le paiement.' },
    'giftcards.form.note.sending': { en: 'Sending…', fr: 'Envoi…' },
    'giftcards.form.note.sent': { en: 'Thanks! Your request was sent. We’ll contact you within a day.', fr: 'Merci! Votre demande a été envoyée. Nous vous contactons en moins d’une journée.' },
    ...
    'privacy.collect.p2': { en: 'If you choose to upload photos or a video of your home with your quote request, those files are stored so we can prepare an accurate quote.', fr: 'Si vous choisissez de téléverser des photos ou une vidéo de votre logement avec votre demande de devis, ces fichiers sont conservés afin que nous puissions préparer un devis précis.' },
    ...
    'home.testimonials.subtitle': { en: 'Real reviews from real clients — 4.9★ average on Google. Here’s what we show up to earn every visit.', fr: 'De vrais avis de vraies personnes — une moyenne de 4,9★ sur Google. Voici ce que nous nous efforçons de mériter à chaque visite.' },
    'home.testimonials.cta': { en: 'Had a cleaning already? We’d be grateful for a few words.', fr: 'Vous avez déjà eu un ménage? Nous apprécierions quelques mots de votre part.' },
    'home.testimonials.ctaLink': { en: 'Share your experience', fr: 'Partager votre expérience' },

    'form.sameDayReminder': { en: '⏱ We typically reply within the same day.', fr: '⏱ Nous répondons habituellement le jour même.' },
