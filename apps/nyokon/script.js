...
const TRANSLATIONS = {
  en: {
    ...
    hero_eyebrow_classic:'NEW ARRIVAL', hero_title_classic:'The Collection', hero_cta_classic:'Discover',
    marquee_1:'CUSTOM STREETWEAR', marquee_2:'MADE TO ORDER', marquee_3:'LIMITED RUNS',
    marquee_1_classic:'CRAFTED IN CAMEROON', marquee_2_classic:'MADE TO ORDER', marquee_3_classic:'TIMELESS SILHOUETTES',
    ...
    editorial_eyebrow_classic:'THE MAISON', editorial_title_classic:'Made to last.',
    editorial_text_classic:"nyøkøn began as one-off pieces made for friends, and still keeps that spirit: every piece is cut and finished by hand in small batches, built to be worn for years rather than one season. This is where you place your own brand story — origin, materials, what sets a nyøkøn piece apart.",
    editorial_cta_classic:'Our Story',
    ...
    checkout_pm_orange_detail:'Pay with your OM wallet', checkout_pm_mtn_detail:'Pay with MTN Mobile Money',
    checkout_pm_cash_detail:'Pay on pickup or delivery', checkout_pm_card_detail:'Visa, Mastercard',
    checkout_pm_fidelity_detail:'Use your loyalty points',
  ...
  fr: {
    ...
    hero_eyebrow_classic:'NOUVEAUTÉ', hero_title_classic:'La Collection', hero_cta_classic:'Découvrir',
    marquee_1:'STREETWEAR SUR MESURE', marquee_2:'FAIT SUR COMMANDE', marquee_3:'SÉRIES LIMITÉES',
    marquee_1_classic:'FABRIQUÉ AU CAMEROUN', marquee_2_classic:'FAIT SUR COMMANDE', marquee_3_classic:'SILHOUETTES INTEMPORELLES',
    ...
    editorial_eyebrow_classic:'LA MAISON', editorial_title_classic:'Fait pour durer.',
    editorial_text_classic:"nyøkøn a commencé avec des pièces uniques faites pour des amis, et garde cet esprit : chaque pièce est coupée et finie à la main, en petite série, pensée pour être portée pendant des années plutôt qu'une saison. C'est ici que tu places ton propre discours de marque — l'origine, les matières, ce qui distingue une pièce nyøkøn.",
    editorial_cta_classic:'Notre histoire',
    lookbook_title:'LOOKBOOK',
    ...
    checkout_pm_orange_detail:'Payer avec ton compte OM', checkout_pm_mtn_detail:'Payer avec MTN Mobile Money',
    checkout_pm_cash_detail:'Payer au retrait ou à la livraison', checkout_pm_card_detail:'Visa, Mastercard',
    checkout_pm_fidelity_detail:'Utilise tes points fidélité',
